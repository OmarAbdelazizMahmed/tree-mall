    ...
    public function run()
    {
        ...
        for ($i = 0; $i < 12; $i++) {
            ...
            Product::create([
                ...
                'price' => rand(10, 100),
                'main_image' => 'images/products/main_images/product.png',
                'alt_images' => ['images/products/alt_images/product.png', 'images/products/alt_images/product.png', 'images/products/alt_images/product.png', 'images/products/alt_images/product.png', 'images/products/alt_images/product.png'],
